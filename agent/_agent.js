EAAE,GAAG,EAAE,CAAC,KAAK,CAAC,YAAY,EAAE;IACxC,kBAAkB,EAAE,GAAG,EAAE,CAAC,KAAK,CAAC,kBAAkB,EAAE;IACpD,sBAAsB,EAAE,CAAC,OAAe,EAAE,EAAE,CAAC,KAAK,CAAC,sBAAsB,CAAC,OAAO,CAAC;CACrF,CAAC"}
✄
...
export class MemBrowserAgent {
    ...
    dumpModule(moduleName) {
        const module = Process.getModuleByName(moduleName);
        return module.base.readByteArray(module.size);
    }
    withIl2Cpp(fn) {
        if (!Il2Cpp?.available) {
            return Promise.reject(new Error('IL2CPP not available in target process'));
        }
    ...
    async detectIL2CPP() {
        if (!Il2Cpp?.available) {
            this.il2cppInitialized = false;
            console.log('IL2CPP not detected (Il2Cpp.available=false)');
            return false;
        }
        try {
            await this.withIl2Cpp(() => {
                // Touch the domain to ensure we are attached and ready.
                void Il2Cpp.domain;
            });
            this.il2cppInitialized = true;
            console.log('IL2CPP detected (Il2Cpp.perform ready)');
            return true;
        }
        catch (e) {
            this.il2cppInitialized = false;
            console.log('IL2CPP perform failed: ' + e);
            return false;
        }
    }
    async getIL2CPPHierarchy() {
        if (!this.il2cppInitialized) {
            throw new Error('IL2CPP not initialized (call detectIL2CPP first)');
        }
        return this.withIl2Cpp(() => {
            ...
            const allObjects = ObjectClass
                .method('FindObjectsOfType', 1)
                .invoke(GameObjectClass.type.object);
            for (let i = 0; i < allObjects.length; i++) {
                const obj = allObjects.get(i);
                try {
                    const nameField = obj.method('get_name').invoke();
                    const transform = obj.method('get_transform').invoke();
                    const parent = transform.method('get_parent').invoke();
                    hierarchy.push({
                        address: obj.handle.toString(),
                        name: nameField?.content || 'Unknown',
                        hasParent: !parent.isNull(),
                        parentAddress: parent.isNull() ? null : parent.handle.toString(),
                    });
                }
                catch (e) {
    ...
    async getIL2CPPObjectDetails(address) {
        if (!this.il2cppInitialized) {
            throw new Error('IL2CPP not initialized (call detectIL2CPP first)');
        }
        return this.withIl2Cpp(() => {
            ...
            try {
                ...
                const rotation = transform.method('get_rotation').invoke();
                const scale = transform.method('get_localScale').invoke();
                transformInfo = {
                    position: { x: position.fields.x.value, y: position.fields.y.value, z: position.fields.z.value },
                    rotation: { x: rotation.fields.x.value, y: rotation.fields.y.value, z: rotation.fields.z.value, w: rotation.fields.w.value },
                    scale: { x: scale.fields.x.value, y: scale.fields.y.value, z: scale.fields.z.value },
                };
            }
            catch (e) {
...
rpc.exports = {
    ...
    getModuleInfo: (moduleName) => agent.getModuleInfo(moduleName),
    ...
    setExceptionHandler: (callback) => agent.setExceptionHandler(callback),
    createHook: (address, callback) => agent.createHook(ptr(address), callback),
    getModuleImports: (moduleName) => agent.getModuleImports(moduleName),
    getModuleExports: (moduleName) => agent.getModuleExports(moduleName),
    dumpModule: (moduleName) => agent.dumpModule(moduleName),
    detectIL2CPP: () => agent.detectIL2CPP(),
    getIL2CPPHierarchy: () => agent.getIL2CPPHierarchy(),
    getIL2CPPObjectDetails: (address) => agent.getIL2CPPObjectDetails(address),
};
✄
"use strict";
